...
//		***main getter metod (veya toString) kullanmak tercih edilmeli***
...
//		***Versus this main getter(not bad, still better than calling each method one by one in main method), 
//		or the call to accessor methods (bad, takes too much space)***:
...
//	return type'ýn string olmasýna dikkat**
