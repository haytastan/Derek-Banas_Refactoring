...
// ***amacýmýz 10. tutorialdaki builder pattern ile 9. tutorialdaki 
//composite patterni kombine etmek.
// ancak 10. tutdaki builder patterndeki gibi "artist" classý kullanýlmamýþ 
//ve sadece Item Builder class'ý vasýtasýyla Item object yaratýlmýþ.
// ayný zamanda 9. tutdaki composite patterndeki gibi "component" 
//super classý ve "group" subclassý kullanýlmamýþ***
public class Item {
...
//		**ilk kýsmýn print edilmesini saðlar**
		
		// **Print information on just the Cereal Item and its children
//		Item'daki toString metodunu çaðýrýr**
